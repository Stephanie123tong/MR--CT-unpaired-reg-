...
# Path structure: registration_discriminator -> models -> MASKGAN -> registration_discriminator_solutionB -> multigradICON
# From: registration_discriminator_solutionB/MASKGAN/models/registration_discriminator/
# To: registration_discriminator_solutionB/multigradICON/
