...
# Path structure: registration_discriminator -> models -> MASKGAN -> registration_discriminator_solutionBplus -> multigradICON
# From: registration_discriminator_solutionBplus/MASKGAN/models/registration_discriminator/
# To: registration_discriminator_solutionBplus/multigradICON/
