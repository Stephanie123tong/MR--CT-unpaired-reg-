...
def validation(val_set, model, opt):
    ...
    # Getting SSIM （图像归一化到 [-1,1]，转回 [0,1] 后 data_range=1.0）
    metric_ssim = StructuralSimilarityIndexMeasure(data_range=1.0, reduction="elementwise_mean")
    # Getting PSNR
    metric_psnr = PeakSignalNoiseRatio(data_range=1.0)
